...
@section('title', 'Products Store - ShopHub')
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm sticky top-28 space-y-6">
                    <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                        <h3 class="font-bold text-slate-900 text-lg flex items-center">
                            <i class="fas fa-sliders-h mr-2.5 text-indigo-600"></i> Filters
                        </h3>
                        <a href="{{ route('products.index') }}" class="text-xs font-semibold text-indigo-600 hover:text-indigo-700">Clear All</a>
                    </div>
                    ...
                    <form method="GET" action="{{ route('products.index') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="search" placeholder="Type query..." 
                                    class="w-full pl-4 pr-10 py-2.5 bg-slate-50 border-0 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 text-sm focus:outline-none"
                        ...
                        <div>
                            ...
                            @endphp
                            <select name="category" class="w-full px-4 py-2.5 bg-slate-50 border-0 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 text-sm focus:outline-none">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <input type="number" name="min_price" placeholder="Min $" 
                                    class="w-full px-3 py-2.5 bg-slate-50 border-0 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 text-sm focus:outline-none"
                        ...
                        <div>
                            ...
                            <select name="sort" class="w-full px-4 py-2.5 bg-slate-50 border-0 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 text-sm focus:outline-none">
                        ...
                        <button type="submit" class="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-sm transition shadow-lg shadow-indigo-100 flex items-center justify-center">
                            Apply Filters
                        </button>
                    </form>
                </div>
            ...
            <div class="flex-1">
                ...
                @else
                    <div class="text-center py-20 bg-white rounded-2xl border border-slate-100 shadow-sm">
                        ...
                        <a href="{{ route('products.index') }}" class="mt-4 px-6 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-xl inline-block hover:bg-indigo-700 transition">Reset Search</a>
                    </div>
                @endif
            </div>
        </div>
